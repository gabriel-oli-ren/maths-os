...
/** Helper to get images from GitHub raw content */
const IMG = (name: string) =>
  `https://raw.githubusercontent.com/gabriel-oli-ren/maths-os/main/public/img/${name}`;
...
export const SYSTEM_APPS: SystemApp[] = [
  ...
  { id: "app-strong-dog", name: "Strong Dog", icon: "🐕", url: "https://colute.net/" },
